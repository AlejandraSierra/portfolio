        ...
        <div class="sticky-top container-80-vh py-5">
            <div class="row gx-0 align-content-end bg-container" style="background-image: url('../img/recetario_header.jpg');">
                <div class="col-12 px-5"> 
                    <div class="text-center"><span class="px-3 highlight display-1 text-primary"><?php echo $lang['recetario_titulo']?></span></div>
    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-7">
            <div class="text py-0 py-lg-2 ps-3 info-text">
                <?php echo $lang['recetario_justificacion']?>
            </div>
        </div>
    </div>
</div>
...
<div class="container my-5 py-0 py-lg-5">
    <div class="row">
        ...
        <div class="col-12 col-lg-7">
            <div class="text py-0 py-lg-2 ps-3 info-text">
                <?php echo $lang['recetario_research_ideacion']?>   
            </div>
        </div>
    </div>
</div>
...
<div class="container my-5 py-0 py-lg-5">
    <div class="row">
        ...
        <div class="col-12 col-lg-7">
            <div class="text py-0 py-lg-2 ps-3 info-text">
                <?php echo $lang['recetario_diseno_p1']?>   
                ...
                <div class="pt-3">
                    <?php echo $lang['recetario_diseno_p2']?>
                </div>
            </div>
        </div>
    </div>
...
<div class="container my-5 py-0 py-lg-5">
    <div class="row">
        ...
        <div class="col-12 col-lg-7">
            <div class="text py-0 py-lg-2 ps-3 info-text">
                <?php echo $lang['recetario_desarrollo']?>
            </div>
        </div>
    </div>
</div>
...
<div class="container my-5 py-0 py-lg-5">
    <div class="row">
        ...
        <div class="col-12 col-lg-7">
            <div class="text py-0 py-lg-2 ps-3 info-text">
                <?php echo $lang['recetario_aprendizaje']?>
            </div>
        </div>
    </div>
</div>
...
<div class="row px-2 py-5 p-md-5 gx-0 nav-projects align-items-center">
    ...
    <div class="col-3 text-end">
        <a href="appio.php" class="project-btn"><?php echo $lang['btn_siguiente_proyecto']?><i class="fa-solid fa-arrow-right ps-2"></i></a>
    </div>
</div>
