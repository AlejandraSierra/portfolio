<?php
    $nombrePagina = "Política de Privacidad";
...
<div class="container my-5">
    ...
    <p class="display-1 py-3">Política de Privacidad</p>

    El presente Política de Privacidad establece los términos en que el sitio web de Alejandra Sierra usa y protege la
    ...
    Alejandra Sierra está altamente comprometida para cumplir con el compromiso de mantener su información
    ...
    menos de que usted así lo quiera y la proporcione directamente. Usted puede aceptar o negar el uso de cookies, sin embargo la mayoría de
    ...
    somos responsables de los términos o privacidad ni de la protección de sus datos en esos otros sitios terceros. Dichos sitios están sujetos a
    sus propias políticas de privacidad por lo cual es recomendable que los consulte para confirmar que usted está de
    acuerdo con estas.<br><br>
    ...
    opción de recibir nuestro boletín o publicidad usted puede cancelarla en cualquier momento.<br>
    ...
    Alejandra Sierra Se reserva el derecho de cambiar los términos de la presente Política de Privacidad en
    cualquier momento.
